    ...
    <div class="min-h-screen bg-[#fafafa] text-neutral-900 pt-30">
      <section class="w-full flex flex-col px-4 items-center">
        @for (project of projects; track project.title) {
          ...
          >
            <div class="overflow-hidden rounded hover:scale-105 transition duration-700 h-100 w-full sm:w-120 sm:h-160">
              <img
                [src]="project.image"
                (click)="lightbox.open(project.image)"
                [alt]="project.title + ' project'"
                class="w-full sm:w-120 sm:h-160 h-100 cursor-pointer"
              />
            </div>
  ...
  ngOnInit(): void {
    this.projects = [
      ...
      },
      {
        ...
        hoverColor: 'hover:bg-gradient-to-tl hover:from-[#ff7f00]/70',
      },
      {
        title: 'Canvas',
        ...
        hoverColor: 'hover:bg-gradient-to-tl hover:from-[#fab41b]/70',
      },
      {
        title: 'LASESIÓN',
        ...
        hoverColor: 'hover:bg-gradient-to-tl hover:from-[#8a4980]/70',
      },
      {
        title: 'The Monolith',
        ...
        hoverColor: 'hover:bg-gradient-to-tl hover:from-[#000]/70',
      },
      {
        title: 'TEETH & GLASS',
        ...
        hoverColor: 'hover:bg-gradient-to-tl hover:from-[#5f0503]/70',
      },
      {
        ...
        hoverColor: 'hover:bg-gradient-to-tl hover:from-[#ba0001]/70',
      },
      {
        title: 'EL VEJIGANTE',
        ...
        hoverColor: 'hover:bg-gradient-to-tl hover:from-[#1597f5]/70',
      },
      {
        ...
        hoverColor: 'hover:bg-gradient-to-tl hover:from-[#ffd200]/70',
      },
      {
        ...
        hoverColor: 'hover:bg-gradient-to-tl hover:from-[#a60404]/70',
      },
      {
        ...
        hoverColor: 'hover:bg-gradient-to-tl hover:from-[#a17c01]/70',
      },
    ];
  }
}
